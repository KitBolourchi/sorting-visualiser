...
def main():
    ...
    lst = create_starting_list(n, min_value, max_value)
    ...
    sorting_alogirthm_generator = None
    ...
    while run:
        ...
        if sorting:
            try:
                next(sorting_alogirthm_generator)
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r:
                ...
                sorting = True
                sorting_alogirthm_generator = sorting_algorithm(draw_info, ascending)
